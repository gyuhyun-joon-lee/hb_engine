...
@autoreleasepool
{
    ...
    m4x4 light_proj = orthogonal_projection(0.01f, 10000.0f, 150.0f, render_context->directional_light_shadowmap_depth_texture.width / (f32)render_context->directional_light_shadowmap_depth_texture.height);
            ...
            )
    {
        ...
        switch(header->type)
        {
            ...
            case RenderEntryType_ArbitraryMesh:
            {
                ...
                PerObjectData per_object_data = {};
                per_object_data.model = identity_m4x4();
                per_object_data.color = entry->color;
